...
public class ContaBanco {
    ...
    public void fecharConta(){
        if (this.getSaldo() > 0){
            System.out.println("Conta não pode ser fechada, possui saldo");
        } else if (this.getSaldo() < 0){
            System.out.println("Conta não pode ser fechada, possui débito");
        } else {
    ...
    public void pagarTarifa(){
        ...
        if (this.getStatus()){
            ...
            System.out.println("Impossível pagaar, conta fechada!");
        } 
    }
